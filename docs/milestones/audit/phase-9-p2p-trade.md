...
**Honesty note 5 — Sixth sprint-006 audit story to find the false decision-extraction pattern.** Spec L212 claims decisions 122-128 are "Extracted to `game_mechanics_decisions.md` for canonical reference." **They are not** — canonical decisions log terminates at Decision 72 (Economy Reconciliation). Same pattern as stories 002 (96-104), 003 (82-86), 004 (87-95), 005 (105-113), 006 (114-121). Combined implied undocumented decisions: 73-81 + 82-86 + 87-95 + 96-104 + 105-113 + 114-121 + 122-128 = **at least 51 decisions** spec-local but not in canonical log. **Sixth consecutive sprint-006 audit** finding this pattern — capstone bulk-fix is critical-overdue.
