...
1. **Entire M7.1–M7.4 milestone series is unshipped.** Capstone (story-007) should mark Phase 7 as NOT_STARTED in `docs/milestones/07_bestiary.md`. The 41 acceptance boxes are already unchecked — no checkmarks to revert, but the milestone-level "Goal" framings imply ongoing work and should be re-flagged as deferred.
