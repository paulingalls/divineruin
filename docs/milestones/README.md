...
| 7 · Bestiary | [07_bestiary.md](07_bestiary.md) | 🟡 Partial | 11/41 ACs | The authored tier table, universal stat-block validators, two Tier 1 Hollow exemplars, and the indexed creatures table ship; regional catalog, DM query surface, and encounter mechanics remain open. |
