...
| 7 · Bestiary | [07_bestiary.md](07_bestiary.md) | 🟡 Partial | 22/41 ACs | The tier table, validators, all 9 spec-authored Hollow creatures, and all 19 spec-authored natural creatures ship; DM query surface and encounter mechanics remain open. |
