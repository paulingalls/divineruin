...
- [x] Each natural creature has a distinct tactics and morale pair <!-- verified apps/agent/tests/test_creature_distribution.py::test_natural_creature_distribution -->
