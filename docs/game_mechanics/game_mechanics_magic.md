...
| **Resurrection** | 8 | 3 | 10 | Single (dead) | Touch | Instant | Return creature dead up to 10 days to life, full HP. Diamond (500 gp, consumed). Soul must be willing. Doesn't work if soul passed beyond Mortaen's domain. Returns with 1 exhaustion. | This is negotiation with death itself. You reach across Mortaen's threshold and ask for them back. | Silence → STG-006 (Mortaen) → heartbeat |
