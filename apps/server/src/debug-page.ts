export const DEBUG_HTML = /* html */ `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<div class="section" id="sec-portraits">
  <h2>Portraits</h2>
  <div class="grid">
    <button class="btn" onclick="send({type:'session_init',portraits:{companion:{primary:'/api/assets/images/placeholder',alert:'/api/assets/images/placeholder'},npcs:{INNKEEPER_MAREN:{name:'Maren',url:'/api/assets/images/placeholder'},GUILDMASTER_TORIN:{name:'Guildmaster Torin',url:'/api/assets/images/placeholder'},SCHOLAR_EMRIS:{name:'Emris of the Diaspora',url:'/api/assets/images/placeholder'},GRIMJAW_BLACKSMITH:{name:'Grimjaw',url:'/api/assets/images/placeholder'},ELDER_YANNA:{name:'Elder Yanna',url:'/api/assets/images/placeholder'}}}})">Setup NPC Portrait Map</button>
    <button class="btn" onclick="send({type:'player_portrait_ready',url:'/api/assets/images/placeholder'})">Player Portrait Ready</button>
    <button class="btn" onclick="send({type:'transcript_entry',speaker:'npc',character:'INNKEEPER_MAREN',emotion:'warm',text:'Your usual table is free, traveler.',timestamp:Date.now()/1000})">NPC Transcript (Maren)</button>
    <button class="btn" onclick="send({type:'transcript_entry',speaker:'npc',character:'GUILDMASTER_TORIN',emotion:'serious',text:'We need to move before nightfall.',timestamp:Date.now()/1000})">NPC Transcript (Torin)</button>
  </div>
</div>
...
<div class="section" id="sec-transcript">
  ...
  <div class="grid">
    ...
    <button class="btn" onclick="send({type:'transcript_entry',speaker:'npc',character:'INNKEEPER_MAREN',emotion:'warm',text:'Welcome back, traveler. Your usual table is free — and I have news about that merchant you were asking after.',timestamp:Date.now()/1000})">NPC Dialogue</button>
