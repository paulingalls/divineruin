...
export const PROMPT_TEMPLATES: Record<string, ImagePromptTemplate> = {
  companion_portrait_primary: {
    ...
    promptText: `Ink wash portrait of the subject, a {{age}} {{gender}} {{species}}, on a dark near-black background. Their appearance is {{appearance}}. Bust composition, three-quarter view facing slightly left. The subject's face, eyes, and defining features are rendered in confident ink brushwork with careful detail. The head and upper body dissolve into scattered ink marks and raw graphite sketch lines at the edges. The lower portion of the portrait fades into bare aged paper texture. Monochrome — black ink and graphite on dark cream paper. No color. Partially unfinished, with the dissolving edges suggesting the subject is being remembered rather than observed. Fine art quality, visible brushwork, hand-drawn feel. Aspect ratio 3:4.`,
    variableSlots: ["appearance", "species", "gender", "age"],
    aspectRatio: "3:4",
    accentColor: "none",
    accentHex: null,
  },
  ...
  companion_portrait_alert: {
    ...
    promptText: `Ink wash portrait of the subject, a {{age}} {{gender}} {{species}}, in a three-quarter bust view on a dark near-black background. Their appearance is {{appearance}}. The subject is tense and alert, with an expression and posture focused on a nearby threat. Defining features are rendered in confident ink brushwork, dissolving into loose gestural strokes and scattered ink marks at the edges. Quick, energetic brush strokes suggest sudden movement. A faint teal watercolor wash bleeds subtly across one side of the subject — barely visible, like a stain spreading. Aged paper texture, ink bleed at stroke edges. Mostly monochrome with only that subtle teal accent. Partially unfinished, atmospheric. Aspect ratio 3:4.`,
    variableSlots: ["appearance", "species", "gender", "age"],
    aspectRatio: "3:4",
  ...
  player_character_creation: {
    ...
    promptText: `Ink wash portrait of a {{race_name}} {{class}} on a dark near-black background. This character is a {{race_name}} — {{physical_features}}. Their role is {{class}} — {{class_fantasy}}. Front-facing bust composition. The face is the focal point — rendered with detailed ink brushwork clearly showing the distinctive {{race_name}} racial features. Their gear and bearing should reflect their role as a {{class}}. Expression is neutral but present, as if meeting the viewer's gaze for the first time. Below the collarbone, the figure dissolves rapidly into loose brushwork, then scattered marks, then bare paper. Monochrome — black ink and graphite on dark cream paper. No background detail. The character emerges from darkness and fades back into it. Partially unfinished. Fine art quality, visible brush strokes, hand-drawn feel. Aspect ratio 3:4.`,
    variableSlots: ["class", "race_name", "physical_features", "class_fantasy"],
    aspectRatio: "3:4",
    accentColor: "none",
    accentHex: null,
  },
