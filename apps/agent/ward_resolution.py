...
milestone exists to remove, rebuilt one layer up. So every consumer (the cast path, the
activation tool, arrival) calls ``resolve_scope_ward``. Nobody re-derives it.
