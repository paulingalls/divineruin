...
class TestAdvanceOnboardingBeat:
    ...
    async def test_advance_beat_1_to_2(self, mock_db):
        ...
        mock_db.set_player_flag.assert_awaited_once_with("player_1", "onboarding_beat", 2)

    @pytest.mark.asyncio
    @patch("onboarding_tools.db")
    async def test_advance_beat_2_to_3(self, mock_db):
        from onboarding_tools import advance_onboarding_beat
    ...
    @pytest.mark.asyncio
    @patch("onboarding_tools.db")
    async def test_advance_beat_3_initializes_companion(self, mock_db):
        ...
        calls = mock_db.set_player_flag.await_args_list
    ...
    @pytest.mark.asyncio
    @patch("onboarding_tools.db")
    async def test_advance_beat_4_to_5(self, mock_db):
        from onboarding_tools import advance_onboarding_beat
    ...
    @pytest.mark.asyncio
    @patch("onboarding_tools.db")
    async def test_advance_beat_5_returns_city_agent_handoff(self, mock_db):
        ...
        mock_db.set_player_flag.assert_any_await("player_1", "onboarding_beat", ONBOARDING_COMPLETE)
    ...
    @pytest.mark.asyncio
    @patch("onboarding_tools.db")
    async def test_advance_preserves_location(self, mock_db):
