...
Pure functions for the workspace layer: the WorkspaceType vocabulary used by the
three-check pipeline's Check 3 (story-003), settlement-by-size availability, and
rental pricing with disposition modifiers. DB reads (a player's
