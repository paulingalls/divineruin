...
// fields below PLUS 4 M3.3 cast-time fields (resonance_by_source, terrain_effects, audio_cue,
// concentration).
//
...
// dataclass. The 4 M3.3 fields are deliberately omitted because no TS code reads them: this
