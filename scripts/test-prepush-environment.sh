...
want_line "Python database is unset" "$S/python.env" "DATABASE_URL=<unset>"
want_line "Python redis is unset" "$S/python.env" "REDIS_URL=<unset>"
...
want_line "server strips external APIs" "$S/server.env" "DEEPGRAM_API_KEY=<unset>"
want_line "Python strips external APIs" "$S/python.env" "DEEPGRAM_API_KEY=<unset>"
