...
-- disposition modifiers, a price multiplier, and a description; the name_pool row carries
-- the given names and surnames generated rosters draw from. The agent
