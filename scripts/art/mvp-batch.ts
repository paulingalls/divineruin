import { buildCompanionBatch } from "./companion-batch.ts";
import type { BatchEntry, CompanionArtRow } from "./companion-batch.ts";

const companions = (await Bun.file(
  new URL("../../content/companions.json", import.meta.url),
).json()) as CompanionArtRow[];

export const MVP_BATCH: BatchEntry[] = [
  ...buildCompanionBatch(companions),
